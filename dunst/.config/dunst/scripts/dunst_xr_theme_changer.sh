...
declare -A theme_attr_dict=(
    ["global-font"]="$(xrdb_get '*font' 'DejaVuSansMono Nerd Font') $(xrdb_get '*.font_size:' '8')"
    ["global-frame_width"]="$(xrdb_get 'border_width' '1')"
    ["global-frame_color"]="\"$(xrdb_get '*color8' '#65737e')\""

    ["urgency_low-background"]="\"$(xrdb_get '*color0' '#2b303b')\""
    ["urgency_low-foreground"]="\"$(xrdb_get '*color7' '#65737e')\""
    ["urgency_low-frame_color"]="\"$(xrdb_get '*color7' '#65737e')\""

    ["urgency_normal-background"]="\"$(xrdb_get '*color0' '#2b303b')\""
    ["urgency_normal-foreground"]="\"$(xrdb_get '*color6' '#a3be8c')\""
    ["urgency_normal-frame_color"]="\"$(xrdb_get '*color6' '#a3be8c')\""
...
readonly user_conf="$user_conf_dir/scripts/dunstrc"
