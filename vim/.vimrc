" Getting starting configs from vim-configs
...
" " let ALE show the location list for errors
...
""Sourcing playerctl script to show song playing
"if filereadable(expand("~/playerctl.vim"))
"    source ~/playerctl.vim
"endif
